...
require 'dry/transformer/mapper/dsl'
  ...
  module Transformer
    class Mapper
      ...
      module ClassInterface
        ...
        # @example
        #
        #   class MyTransformer < Dry::Transformer[Dry::Transformer]
        #   end
        #
        # @param [Dry::Transformer::Registry] container
        ...
        #
        #   # Setter
        #   Dry::Transformer.container(Dry::Transformer)
        #   # => Dry::Transformer
        #
        #   # Getter
        ...
        #   The container to resolve transprocs from
        #
        # @return [Dry::Transformer::Registry]
        #
        # @api private
